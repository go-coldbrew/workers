...
Child returns a snapshot of a running child worker, or nil if not found. The returned copy is safe for inspection but mutations have no effect on the running worker.
